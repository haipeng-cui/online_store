...
<html lang="en">
  ...
  <body>
    ...
    <h4><i>Sources</i><h4>
        <div class="grid">
          <div class="item"><p>1.  All code is written by me or from our lecture </p></div>
          <div class="item"><p>2. "project\templates\img\logo.png" is from https://www.freepnglogos.com/images/camera-logo-png-7462.html </p></div>
        </div>
    </main>
